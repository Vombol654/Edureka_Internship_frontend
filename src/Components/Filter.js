...
class Filter extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            ...
            this.setState({ restaurants: res.data.restaurants, mealtype: mealtype,location, pageCount : res.data.Data})
        }
    ...
    handleCuisine = (cuisineId) => {
        const { mealtype, location, page,cuisine, sort, lcost, hcost } = this.state;
        ...
        axios({
            ...
            .then(res => {
                this.setState({
                    ...
                    cuisine,pageCount : res.data.Data
...
Breakfast places in Mumbai
                    ...
                    <div className="row">
                        <div className="col-sm-12 col-md-3 col-lg-3 filter-options">
                            ...
                            <span className="glyphicon glyphicon-chevron-down toggle-span ram" data-toggle="collapse"
                                    data-target="#filter"></span></div>
                                     <div id="filter" className="collapse show">
                            <div  className="a1">Select Location</div>
                            <select name="" id="" className="b" onChange={this.handleLocatiomChange}>
                            ...
                            <div className="d">
                                <input type="checkbox" name="ni" onChange={() => this.handleCuisine(1)} />
                                <label for="ni">North Indian</label>
                            </div>
                            <div className="d">
                                <input type="checkbox" name="ni" onChange={() => this.handleCuisine(2)} />
                                <label for="ni">South Indian</label>
                            </div>
                            <div className="d">
                                <input type="checkbox" name="ni" onChange={() => this.handleCuisine(3)} />
                                <label for="ni">Chinease</label>
                            </div>
                            <div className="d">
                                <input type="checkbox" name="ni" onChange={() => this.handleCuisine(4)} />
                                <label for="ni">Fast Food</label>
                            </div>
                            <div className="d">
                                <input type="checkbox" name="ni" onChange={() => this.handleCuisine(5)} />
                                <label for="ni">Street Food</label>
                            </div>
                            <div className="e">Cost for Two</div>
                            <div className="f">
                                <input type="radio" name="one" onChange={() => this.handleCost(1, 500)} />
                                <label for="" className="d">less than 500</label>
                            </div>
                            <div className="f">
                                <input type="radio" name="one" onChange={() => this.handleCost(500, 999)} />
                                <label for="">500-999</label>
                            </div>
                            <div className="f">
                                <input type="radio" name="one" onChange={() => this.handleCost(1000, 1499)} />
                                <label for="">1000-1499</label>
                            </div>
                            <div className="f">
                                <input type="radio" name="one" onChange={() => this.handleCost(1500, 2499)} />
                                <label for="">1500-2499</label>
                            </div>
                            <div className="f">
                                <input type="radio" name="one" onChange={() => this.handleCost(2500, 22499)} />
                                <label for="">2500+</label>
                            </div>
                            <div className="g">Sort</div>
                            <div className="h">
                                <input type="radio" name="two" onChange={() => this.handleSorting(1)} />
                    ...
                    <div className="col-sm-12 col-md-9 col-lg-9">
                        {restaurants.length != 0 ? restaurants.map((item) => {
                            return <div className="right-top" onClick={() => this.handleRestaurants(item._id)}>
                                <div className="right-left">
                                    <img src="./Assets/lunch.jpg" alt="image" height="120px" width="100px" />
                                </div>
